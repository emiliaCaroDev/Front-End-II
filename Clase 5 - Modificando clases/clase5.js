...
function elegirTema() {
    const result = confirm('Desea usar el modo oscuro');
    result ? sitio.classList.toggle("dark") : null;
    sitio.classList.contains("dark") ? btnTema.innerText = "Cambiar a modo claro 🌞" : btnTema.innerText = "Cambiar a modo oscuro 🌛";
}
